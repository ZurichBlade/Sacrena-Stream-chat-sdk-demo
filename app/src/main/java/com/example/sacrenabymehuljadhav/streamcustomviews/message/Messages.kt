        ...
        LazyColumn(
            ...
            itemsIndexed(
                ...
                Box(modifier = finalItemModifier) {
                    ...
                    val newestMessageItem =
                        (messages.firstOrNull { it is MessageItemState } as? MessageItemState)
                    if (index == 0 &&
                        messages.isNotEmpty() &&
                        lazyListState.isScrollInProgress
                    ) {
...
internal fun BoxScope.DefaultMessagesHelperContent(
    ...
    val focusedItemIndex =
        messages.indexOfFirst { it is MessageItemState && it.focusState is MessageFocused }
