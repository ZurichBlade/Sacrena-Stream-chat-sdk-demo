...
import com.example.sacrenabymehuljadhav.streamcustomviews.message.DefaultMessageTextContent
...
//                onLinkClick = onLinkClick,
        ...
        // Add the new Row with timestamp at the bottom
        ...
        if (date != null) {
            Row(
                modifier = Modifier
                    .wrapContentWidth()
                    .align(Alignment.End)
                    .padding(top = 0.dp, bottom = 8.dp, start = 10.dp, end = 8.dp),
            ) {
