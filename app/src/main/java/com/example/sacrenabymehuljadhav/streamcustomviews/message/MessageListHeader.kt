...
import com.example.sacrenabymehuljadhav.streamcustomviews.componenets.OnlineIndicator
import com.example.sacrenabymehuljadhav.streamcustomviews.previewdata.PreviewChannelData
            ...
            Row(
                ...
                Icon(
                    modifier = Modifier
                        ...
                        .size(36.dp)
                        .clickable { },
                    painter = painterResource(id = com.example.sacrenabymehuljadhav.R.drawable.more_horiz_24px),
...
internal fun DefaultMessageListHeaderLeadingContent(onBackPressed: () -> Unit) {
    ...
    Box(
        ...
        Icon(
            ...
            painter = painterResource(id = com.example.sacrenabymehuljadhav.R.drawable.round_arrow_back_ios_24),
            contentDescription = "",
            tint = Color.White
        )
    }
